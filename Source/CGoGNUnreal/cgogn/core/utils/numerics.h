...
#include <CGoGNUnreal/cgogn/core/utils/assert.h>
...
struct name_of_type
{
	...
	{
		cgogn_message_assert(false, "You must specialize name_of_type straits");
		return "";
	}
};
