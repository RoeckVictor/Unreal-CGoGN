...
template <>
struct name_of_type<geometry::Vec2>
{
...
template <>
struct name_of_type<geometry::Vec3>
{
	inline static std::string name()
	{
		return "Vec3";
...
template <>
struct name_of_type<geometry::Vec4>
{
	inline static std::string name()
	{
		return "Vec4";
...
template <>
struct name_of_type<geometry::Mat2>
{
	inline static std::string name()
	{
		return "Mat2";
...
template <>
struct name_of_type<geometry::Mat3>
{
	inline static std::string name()
	{
		return "Mat3";
...
template <>
struct name_of_type<geometry::Mat4>
{
	inline static std::string name()
	{
		return "Mat4";
...
template <>
struct name_of_type<geometry::Vec2f>
{
	inline static std::string name()
	{
		return "Vec2f";
...
template <>
struct name_of_type<geometry::Vec3f>
{
	inline static std::string name()
	{
		return "Vec3f";
...
template <>
struct name_of_type<geometry::Vec4f>
{
	inline static std::string name()
	{
		return "Vec4f";
...
template <>
struct name_of_type<geometry::Mat2f>
{
	inline static std::string name()
	{
		return "Mat2f";
...
template <>
struct name_of_type<geometry::Mat3f>
{
	inline static std::string name()
	{
		return "Mat3f";
...
template <>
struct name_of_type<geometry::Mat4f>
{
	inline static std::string name()
	{
		return "Mat4f";
